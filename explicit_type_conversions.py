...
print('  empty float:', float()) # 0.0
print('  int to float:', float(1298)) # 1298.0
print('  string (float) to float:', float('8.91')) # 8.91
print('  string (float) to float:', float('.1')) # 0.1
print('  string (float with spaces) to float', float(' 5.21 ')) # 5.21 removes the spaces
print('  string (int) to float:', float('176')) # 176.0
print('  string (int with spaces) with spaces to float', float(' 962 ')) # 962.0 removes the spaces
...
print('\n\n######### Exercises #########')
print('converting a string float to in', int(float('4.5')))